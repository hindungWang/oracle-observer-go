...
type RadioRewardShare struct {
	...
	StartEpoch uint64 `protobuf:"varint,5,opt,name=start_epoch,json=startEpoch,proto3" json:"start_epoch,omitempty" gorm:"type:timestamp"`
	EndEpoch   uint64 `protobuf:"varint,6,opt,name=end_epoch,json=endEpoch,proto3" json:"end_epoch,omitempty" gorm:"type:timestamp"`
}
